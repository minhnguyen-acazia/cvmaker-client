...
const FormInstance = ({ idx, deleteEntry, data, handleInputChange }) => {
  return (
    <div className='set'>
      <FormInput className='field' label='Course name' maxLength='100' type='text' name='courseName' value={data.courseName} onChange={(e) => handleInputChange(e, FormID, idx)} />
      <FormInput className='field' label='Institution name' maxLength='100' type='text' name='institutionName' value={data.institutionName} onChange={(e) => handleInputChange(e, FormID, idx)} />
