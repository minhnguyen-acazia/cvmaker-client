...
export function FormBasicInformation({ title, data, handleInputChange, handleImageUpload, authenticated }) {
  return (
    <FormBlueprint title={title}>
      <div className='sets'>
        <div className='set'>
          ...
          {authenticated ? (
            <ImageUploader handleImageUpload={handleImageUpload} previewImage={data.previewImage} />
